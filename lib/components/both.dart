...
class _DisplayState extends State<Both> {
...
void onchangeDate(){
      ...
      list=originalData.items!.where((item) =>item.ricemill.toString().toLowerCase().contains(RiceMill.text.toLowerCase())).toList();
      list=list.where((item) =>item.party.toString().toLowerCase().contains(party.text.toLowerCase())).toList();
                 ...
                 child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                     child:SingleChildScrollView(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left:18.0),
                        child: Input("partyName",TextInputType.name,party,Icons.near_me),
                      ),
